...
#define kboardBarTopMidDistance  kScreenScaleHeightWithOriginal(12)
#define kboardBarLeftMidDistance kScreenScaleWidthWithOriginal(10)
#define kboardBarItemMidDistance kScreenScaleWidthWithOriginal(14)

#define kboardBarItemWidth  ((kSelfWidth-2*kboardBarLeftMidDistance-7*kboardBarItemMidDistance)/8)
#define kboardBarItemHeight (kSelfHeight-2*kboardBarTopMidDistance)

@interface BoardToolBar_rootBar ()
...
@implementation BoardToolBar_rootBar
...
- (void)AddItems{
    for (int i=0; i<self.itemArr.count; i++) {
        ...
        item.frame = CGRectMake(kboardBarLeftMidDistance +
                                i * (kboardBarItemWidth + kboardBarItemMidDistance),
                                kboardBarTopMidDistance,
                                kboardBarItemWidth,
                                kboardBarItemHeight);
